...
using WolvenKit.Scripting;

namespace WolvenKit.ViewModels.Documents;

public class WScriptDocumentViewModel : DocumentViewModel
{
    ...
    private void Run()
    {
        ...
        {
            engine.AddHostObject("wkit", new WKitScripting());
            try
            {
                engine.Execute(Document.Text);
            }
            catch (Exception)
            {

        ...
        public void CalculateProperties()
        {
            ...
            else if (obj is RedBaseClass redClass)
            {
                ...
                foreach (var nativeProperty in pis)
                {
                    ...
                    Properties.Add(new ChunkViewModel(redClass.GetProperty(name), this, nativeProperty.RedName, false, isreadonly));
                }

                foreach (var dynamicProperty in dps)
                {
                    Properties.Add(new ChunkViewModel(redClass.GetProperty(dynamicProperty), this, dynamicProperty, false, isreadonly));
                }
            }
